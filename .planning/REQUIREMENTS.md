...
| FR-03-4 | Stripe integration: create payment intent, handle webhook events (payment_intent.succeeded, invoice.paid) | Existing | Must | ✅ 03-02 |
| FR-03-5 | Email notifications: send invoice/reminder emails via Gmail SMTP or Supabase SMTP | Existing | Must | ✅ 03-02 |
...
| FR-03-8 | Client portal: public link to view/pay invoice (no login required for client) | Existing | Should | ✅ 03-02 |
