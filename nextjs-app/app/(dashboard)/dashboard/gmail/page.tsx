  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Intégration messagerie</p>
          </div>
        </div>
        <button
          disabled
      ...
      <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-xl px-4 py-4">
        ...
        <div>
          <p className="text-sm font-medium text-amber-800">Intégration Gmail en cours de développement</p>
          <p className="text-xs text-amber-600 mt-1">
            Cette intégration permettra de synchroniser vos emails Gmail avec les contacts, deals
            et dossiers clients directement depuis l&apos;ERP.
          </p>
        </div>
      </div>
          ...
          <tbody>
            <tr>
              <td colSpan={3} className="px-4 py-12 text-center text-gray-300">
                ...
                <p>Connexion Gmail requise pour afficher les emails</p>
              </td>
            </tr>
          </tbody>
        </table>
